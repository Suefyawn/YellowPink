...
export default async function AdminHelpPage() {
  ...
  return (
    <div className="adm-page" style={{ padding: '32px 36px' }}>
      ...
      <style>{`
        .yp-manual { color: #1f2937; font-size: 0.9375rem; line-height: 1.65; }
        ...
        .yp-manual pre { background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 14px 16px; overflow-x: auto; }
        ...
        .yp-manual table { width: 100%; border-collapse: collapse; margin: 0 0 18px; font-size: 0.875rem; }
