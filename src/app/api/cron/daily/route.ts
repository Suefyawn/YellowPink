...
//   4. review-requests      — ask for reviews on orders delivered 3–30 days ago
//   5. low-stock            — email the owner a low-stock restock digest
//   6. not-found-digest     — email the owner newly-broken (404) URLs
