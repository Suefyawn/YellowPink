...
// passed down from SiteChrome (store_whatsapp || store_phone); renders nothing
  ...
  return (
    <a
      ...
      style={{
        ...
        bottom: 'calc(max(12px, env(safe-area-inset-bottom)) + var(--fab-bottom-offset, 0px))',
        zIndex: 90,
        display: 'inline-flex',
        alignItems: 'center',
        gap: 10,
    ...
    >
      ...
      <span
        style={{
          // 48px bubble with a cream ring — big enough as a tap target, small
          // enough that it stops overlapping card titles near the corner.
          // WhatsApp green stays: green is reserved for WhatsApp actions.
