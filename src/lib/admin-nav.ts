...
export const ADMIN_NAV: AdminNavGroup[] = [
  ...
  { label: 'Customers', items: [
    ...
    { href: '/admin/winback',   label: 'Win-back',  icon: 'send', permission: 'customers.view' },
    { href: '/admin/broadcast', label: 'Broadcast', icon: 'smartphone', permission: 'customers.view' },
  ...
  { label: 'Marketing', items: [
    ...
    { href: '/admin/outreach',  label: 'Outreach',  icon: 'send', permission: 'outreach' },
